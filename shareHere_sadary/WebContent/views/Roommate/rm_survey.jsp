...
<head>
    ...
    <link rel="stylesheet" href="rm_survey.css">
...
<body class="container">
    ...
    <article class="start">
        ...
        <h1 class="mt-5 text-center">나는 어떤 룸메이트일까?</h1> 
        <br>
        <h4 class = "text-center" > <span style="color: rgb(87, 134, 236)">룸메이트 유형검사</span>를 통해 본인의 유형과 <br>
        본인에게 적합한 <span style="color : orange; font-weight: bold;">쉐어메이트</span>를 추천받아보세요 ! </h4>
        <br>
        <img src = "img/rm_startimg.PNG" class = "mt-5">
        <pre >             어머님이 누구니                               친해지고 싶은 너                            이성적 겉바속촉                         복세편살 바로 나  </pre>
    ...
    <article class="question">
        ...
        <img id = "question_img" class = "mt-5" src = "img/question1.jpg" alt = "question image">
    ...
    <article class="result">
        <img id="img_result" class="rounded-circle mt-5" src="lion.jpg" alt="animal">
    ...
    <script>
    	var to_intro = document.getElementById('to_intro');
    	to_intro.addEventListener('click', function() {
    		location.href="<%= request.getContextPath() %>/views/Roommate/rn_introPage.jsp";
    	});
    </script>
