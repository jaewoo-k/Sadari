...
<body>
	<div class="house roomInfo">
		<h2>방 정보</h2>
		<hr>
		<b id="sub">방은 최대 4개 입력할 수 있습니다. <br> + 버튼을 누르시면 입력하실 수 있는 방
			form이 나옵니다. <br> 순서대로 입력해주세요!
		</b> <br>
		<br>
		<div id="roomInfo1">
			<span id="rbox"
		...
		<div id="rp" style="padding-top: 4%;">
			...
			<div style="padding-top: 1%;">
				<select name="shGender" class="rType">
					...
					<option class="option" value="남자">남자</option>
					<option class="option" value="여자">여자</option>
				</select>
			</div>
		</div>
		<!-- 면적(방 면적) -->
