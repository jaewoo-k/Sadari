...
<body>
    <div class="leftMenu">
        ...
        <div id="title_Btns">
            <ul id="btnList"> 
                <li><button class="menuBtn" id="userBtn" type="button">쉐어하우스 리스트</button></li>
                <li><button class="menuBtn" id="hostBtn" type="button">삭제된 매물보기</button></li>
            </ul>
        </div>
    </div>

    <div class="summary">
        <h2 id="wrapTitle">삭제쉐하</h2>
